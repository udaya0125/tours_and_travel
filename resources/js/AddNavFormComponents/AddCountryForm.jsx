...
const AddCountryForm = ({ showForm, setShowForm }) => {
    ...
    const mutation = useMutation({
        mutationFn: (name) => {
            ...
            return axios.post(route("ourcountries.store"), formData, {
    ...
    const onSubmit = (data) => mutation.mutate(data.name.trim());
            ...
            >
                <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-sm font-medium text-gray-800">Add new country</span>
                    </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="px-5 py-5 space-y-4">
                    <div className="relative">
                        <label htmlFor="add-country-name" className="block text-xs font-medium text-gray-500 mb-1.5">
