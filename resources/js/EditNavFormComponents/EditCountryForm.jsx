...
// const EditCountryForm = ({ showForm, setShowForm, editingCountry, setEditingCountry }) => {
...
//             return axios.post(route("ourcountries.update", { id }), formData, {
...
//     const onSubmit = (data) => mutation.mutate({ id: editingCountry.id, name: data.name.trim() });
...
//                 .filter((name) => name.toLowerCase().includes(val.trim().toLowerCase()))
//                 .slice(0, 8);
...
//     const handleBlur = () => {
//         setTimeout(() => { setShowSuggestions(false); setActiveSuggestionIndex(-1); }, 150);
//     };
...
//             e.preventDefault();
//             const prev = activeSuggestionIndex <= 0 ? suggestions.length - 1 : activeSuggestionIndex - 1;
...
//                         <span className="text-sm font-medium text-gray-800">Edit country</span>
//                     </div>
...
//                         <label htmlFor="edit-country-name" className="block text-xs font-medium text-gray-500 mb-1.5">
...
//                                             activeSuggestionIndex === i ? "bg-indigo-50 text-indigo-700" : "text-gray-700 hover:bg-gray-50"
//                                         }`}
//                                     >
//                                         <Globe size={12} className="text-gray-300 shrink-0" />
//                                         <span>{highlightMatch(name, countryName)}</span>
//                                     </li>
//                                 ))}
//                             </ul>
//                         )}
...
//                         <button type="button" onClick={handleClose} className="flex-1 px-4 py-2 rounded-full border border-gray-200 text-sm text-gray-500 hover:bg-gray-50 transition-colors">
//                             Cancel
//                         </button>
//                         <button
//                             type="submit"
...
// Define Zod schema (same as AddCountryForm)
