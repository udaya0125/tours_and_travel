...
//                             "include",
//                             "What's Included",
//                             "List all items, services, and amenities included...",
//                         ],
//                         [
//                             "exclude",
//                             "What's Excluded",
//                             "List items, services, or costs not included...",
//                         ],
...
//                                     onChange={(value) =>
//                                         handleRichTextChange(field, value)
//                                     }
//                                     error={
//                                         errors[field]
//                                             ? {
...
//                                                 ? unmarkAllExistingForDeletion
//                                                 : markAllExistingForDeletion
//                                         }
...
// Fields managed by RHF register()
...
const EditPackageForm = ({
    ...
    // Non-RHF state (complex / uncontrolled fields)
    const [selectedImages, setSelectedImages] = useState([]);
    const [existingImages, setExistingImages] = useState([]);
    const [deletingImageIds, setDeletingImageIds] = useState([]);
    const [isDragging, setIsDragging] = useState(false);
    ...
    }, [editingPackage, showForm, allCountry, allSubCategory, reset]);
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            if (status === 422 && resData.errors) {
                ...
                setServerError(resData.message ?? `Unexpected error (${status}).`);
            }
        }
    };
    ...
    const handleCategoryToggle = (id) => {
        ...
        // Reset sub-category if it no longer belongs to any selected category
    ...
    const removeNewImage = (idx) => setSelectedImages((prev) => prev.filter((_, i) => i !== idx));
