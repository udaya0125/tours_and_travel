...
// // Rich Text Editor Component with scrollable content
...
//                 />
//             </div>
//             {error && <FieldError errors={{ [error.field]: [error.message] }} field={error.field} />}
//         </div>
//     );
// };

// // Custom CSS for Quill editor with scrollable content
...
//     .custom-quill .ql-container::-webkit-scrollbar-track {
//         background: #f1f1f1;
//         border-radius: 3px;
//     }
...
//     .custom-quill .ql-container::-webkit-scrollbar-thumb:hover {
//         background: #a8a8a8;
//     }
// `;
...
//         () => allSubCategory.filter((s) => packageForm.category_ids?.includes(String(s.category_id))),
...
//         countryOptions.find((o) => o.value === String(packageForm.country_id)) || null;

//     const selectedSubCategory =
//         subCategoryOptions.find((o) => o.value === String(packageForm.sub_category_id)) || null;

//     const noSubCategories =
//         packageForm.category_ids?.length > 0 && filteredSubCategories.length === 0;
...
//             const newIds = currentIds.includes(sid)
//                 ? currentIds.filter((c) => c !== sid)
//                 : [...currentIds, sid];
...
//                                     setPackageForm((prev) => ({
//                                         ...prev,
//                                         country_id: selected ? selected.value : "",
//                                     }));
...
//                             {allCategory.map((cat) => {
//                                 const checked = packageForm.category_ids?.includes(String(cat.id)) || false;
//                                 return (
//                                     <label
//                                         key={cat.id}
...
//                                     setPackageForm((prev) => ({
//                                         ...prev,
//                                         sub_category_id: selected ? selected.value : "",
//                                     }));
//                                     if (errors.sub_category_id)
//                                         setErrors((prev) => ({ ...prev, sub_category_id: undefined }));
//                                 }}
...
//                             error={errors.short_description ? { field: "short_description", message: errors.short_description[0] } : null}
...
//                             onChange={(value) => handleRichTextChange("long_description", value)}
//                             error={errors.long_description ? { field: "long_description", message: errors.long_description[0] } : null}
...
//                             onChange={(value) => handleRichTextChange("highlight", value)}
//                             error={errors.highlight ? { field: "highlight", message: errors.highlight[0] } : null}
...
//                             onChange={(value) => handleRichTextChange("include", value)}
//                             error={errors.include ? { field: "include", message: errors.include[0] } : null}
//                             placeholder="List all items, services, and amenities included in the package..."
//                         />
//                     </div>

//                     {/* Exclude - Rich Text Editor */}
...
//                             onChange={(value) => handleRichTextChange("exclude", value)}
//                             error={errors.exclude ? { field: "exclude", message: errors.exclude[0] } : null}
...
//                     <div>
//                         <label className="block text-xs font-medium text-gray-500 mb-1.5">
//                             Upload images <span className="text-gray-400 font-normal">(upload new files to add more)</span>
//                         </label>
//                         <input
//                             type="file"
...
const EditPackageForm = ({
    ...
    const unmarkAllExistingForDeletion = () => {
        setDeletingImageIds([]);
    };
                ...
                >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <Select
                                ...
                                value={selectedCountry}
                                onChange={(selected) => {
                                    setPackageForm((prev) => ({ ...prev, country_id: selected ? selected.value : "" }));
                                    if (errors.country_id) setErrors((prev) => ({ ...prev, country_id: undefined }));
                                }}
                                placeholder="Select country"
                                isClearable
                                styles={makeSelectStyles(!!errors.country_id)}
                    ...
                    <div>
                        ...
                        {packageForm.category_ids?.length === 0 ? (
                            ...
                            <Select
                                ...
                                value={selectedSubCategory}
                                onChange={(selected) => {
                                    setPackageForm((prev) => ({ ...prev, sub_category_id: selected ? selected.value : "" }));
                                    if (errors.sub_category_id) setErrors((prev) => ({ ...prev, sub_category_id: undefined }));
                                }}
                                placeholder="Select sub-category"
                                isClearable
                                styles={makeSelectStyles(!!errors.sub_category_id)}
                        ...
                        <React.Fragment key={field}>
                            ...
                            <div>
                                ...
                                <RichTextEditor
                                    ...
                                    error={errors[field] ? { field, message: errors[field][0] } : null}
                                    placeholder={placeholder}
                                />
                            </div>
                        </React.Fragment>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        {[
                            ...
                            <div key={name}>
                                <label className="block text-xs font-medium text-gray-500 mb-1.5">{label}</label>
                                <input name={name} value={packageForm[name] || ""} onChange={handleChange} className={cls(name)} />
                            </div>
                        ))}
                    </div>
