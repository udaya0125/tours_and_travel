...
//           >
//             Aethera<sup className="text-xs font-sans font-normal align-super">®</sup>
//           </span>
...
//                   style={{ fontFamily: 'var(--font-body)', color: '#6F6F6F', textDecoration: 'none' }}
//                 >
//                   {label}
//                 </a>
//               </li>
...
//         >
//           {/* Eyebrow pill */}
//           <div className="animate-fade-rise pill-tag mb-6">
//             <span>✦</span>
//             <span>Curated journeys across 60+ destinations</span>
//           </div>
...
//           >
//             Wander far,{' '}
//             <em style={{ color: '#6F6F6F', fontStyle: 'italic' }}>return changed.</em>
//           </h1>

//           {/* Description */}
//           <p
//             className="animate-fade-rise-delay-2 max-w-xl mt-8 leading-relaxed font-light"
//             style={{
...
//             }}
//           >
//             Handcrafted travel experiences across Nepal, Southeast Asia, and beyond.
//             From Himalayan treks to coastal retreats — we design journeys that stay with you.
//           </p>
...
//           {/* Social proof strip */}
//           <div
//             className="animate-fade-rise-delay-3 flex items-center gap-6 mt-14"
//             style={{ fontFamily: 'var(--font-body)' }}
//           >
//             <div className="flex flex-col items-center">
//               <span className="text-xl font-medium text-black" style={{ fontFamily: 'var(--font-display)' }}>4,800+</span>
//               <span className="text-xs text-gray-400 mt-0.5">Happy travellers</span>
//             </div>
//             <div className="w-px h-8 bg-gray-200" />
//             <div className="flex flex-col items-center">
//               <span className="text-xl font-medium text-black" style={{ fontFamily: 'var(--font-display)' }}>60+</span>
//               <span className="text-xs text-gray-400 mt-0.5">Destinations</span>
//             </div>
//             <div className="w-px h-8 bg-gray-200" />
//             <div className="flex flex-col items-center">
//               <span className="text-xl font-medium text-black" style={{ fontFamily: 'var(--font-display)' }}>12 yr</span>
//               <span className="text-xs text-gray-400 mt-0.5">Of expertise</span>
//             </div>
//           </div>
//         </section>
//       </div>
